...
<head>
    ...
    <meta name="description" content="{{ $meta_description ?? 'Explore inspiring thoughts, blogs, guides, and stories on Unik Muse.' }}">
    <link rel="canonical" href="{{ url()->current() }}">
    <meta property="og:title" content="{{ $meta_title ?? 'Unik Muse - Thoughts That Inspire' }}">
    <meta property="og:description" content="{{ $meta_description ?? 'Explore inspiring thoughts, blogs, guides, and stories on Unik Muse.' }}">
    ...
    <div class="container-unik">
        ...
        <div class="carousel-container rounded-unik-xl relative overflow-hidden shadow-unik-lg my-8 md:my-12">
            <div class="carousel-slide active">
                <img src="{{ asset('assets/snow.jpg') }}" 
                     alt="Snowy Mountain Landscape" 
                     loading="lazy"
                     class="w-full h-64 md:h-96 object-cover">
                <div class="carousel-caption absolute bottom-0 bg-gradient-to-t from-unik-primary/90 via-unik-secondary/50 to-transparent p-6 md:p-8">
                    <h3 class="text-2xl md:text-3xl font-bold text-white mb-2">White Snow</h3>
        ...
        <section class="featured-section my-12 md:my-16">
            ...
            <div class="featured-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Card 1 - Travel -->
                <article class="featured-card bg-white rounded-unik-lg shadow-unik-md border border-unik-border hover:shadow-unik-lg transition-all duration-300 hover:-translate-y-1 flex flex-col h-full">
                    <div class="border-l-4 border-l-unik-primary p-6 flex-grow">
                        <div class="featured-icon w-12 h-12 bg-unik-primary/10 rounded-unik-md flex items-center justify-center mb-4" aria-hidden="true">
                        ...
                        <div class="mt-auto pt-4">
                            <a href="/guides" class="featured-link inline-flex items-center text-unik-primary font-medium hover:text-unik-secondary transition-colors text-sm"
                ...
                <article class="featured-card bg-white rounded-unik-lg shadow-unik-md border border-unik-border hover:shadow-unik-lg transition-all duration-300 hover:-translate-y-1 flex flex-col h-full">
                    <div class="border-l-4 border-l-unik-secondary p-6 flex-grow">
                        <div class="featured-icon w-12 h-12 bg-unik-secondary/10 rounded-unik-md flex items-center justify-center mb-4" aria-hidden="true">
                        ...
                        <div class="mt-auto pt-4">
                            <a href="/inspiration" class="featured-link inline-flex items-center text-unik-primary font-medium hover:text-unik-secondary transition-colors text-sm" 
                ...
                <article class="featured-card bg-white rounded-unik-lg shadow-unik-md border border-unik-border hover:shadow-unik-lg transition-all duration-300 hover:-translate-y-1 flex flex-col h-full">
                    <div class="border-l-4 border-l-unik-accent p-6 flex-grow">
                        <div class="featured-icon w-12 h-12 bg-unik-accent/10 rounded-unik-md flex items-center justify-center mb-4" aria-hidden="true">
                        ...
                        <div class="mt-auto pt-4">
                            <a href="/photo-stories" class="featured-link inline-flex items-center text-unik-primary font-medium hover:text-unik-secondary transition-colors text-sm" 
                ...
                <article class="featured-card bg-white rounded-unik-lg shadow-unik-md border border-unik-border hover:shadow-unik-lg transition-all duration-300 hover:-translate-y-1 flex flex-col h-full">
                    <div class="border-l-4 border-l-unik-light p-6 flex-grow">
                        <div class="featured-icon w-12 h-12 bg-unik-light/20 rounded-unik-md flex items-center justify-center mb-4" aria-hidden="true">
                        ...
                        <div class="mt-auto pt-4">
                            <a href="/collections" class="featured-link inline-flex items-center text-unik-primary font-medium hover:text-unik-secondary transition-colors text-sm" 
        ...
        <div class="page-wrapper my-12 md:my-16">
            <div class="layout-container grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                ...
                <main class="content-area lg:col-span-2">
                    <h2 class="section-title text-2xl md:text-3xl font-bold text-unik-primary mb-2">Latest From Unik Muse</h2>
                    ...
                    <div class="blog-grid grid grid-cols-1 md:grid-cols-2 gap-6">
                        @foreach ($data as $value)
                            <article class="blog-card bg-white rounded-unik-lg shadow-unik-md border border-unik-border hover:shadow-unik-lg transition-all duration-300 hover:-translate-y-1 flex flex-col h-full">
                                ...
                                <div class="card-content p-6 flex-grow">
                                    <h3 class="card-title text-lg md:text-xl font-semibold text-unik-dark mb-3">{{ $value->title }}</h3>
                                    <p class="card-text text-unik-muted mb-4 text-sm md:text-base leading-relaxed line-clamp-3">{{ Str::limit($value->description, 150) }}</p>

                                    <div class="card-meta flex justify-between items-center mt-auto pt-4 border-t border-unik-border">
                ...
                <aside class="sidebar lg:col-span-1 space-y-6">
                    <div class="sidebar-box sticky-ad sticky bg-white rounded-unik-lg shadow-unik-sm p-6 border border-unik-border">
                    ...
                    <div class="sidebar-box bg-white rounded-unik-lg shadow-unik-sm p-6 border border-unik-border">
                        ...
                        <ul class="sidebar-list space-y-2">
                            <li><a href="#" class="nav-link block p-2 rounded-unik-md hover:bg-unik-primary/5 text-unik-primary transition-colors">Technology</a></li>
                            <li><a href="#" class="nav-link block p-2 rounded-unik-md hover:bg-unik-secondary/5 text-unik-secondary transition-colors">Travel</a></li>
                            <li><a href="#" class="nav-link block p-2 rounded-unik-md hover:bg-unik-accent/5 text-unik-accent transition-colors">News</a></li>
                            <li><a href="#" class="nav-link block p-2 rounded-unik-md hover:bg-unik-light/20 text-unik-secondary transition-colors">Lifestyle</a></li>
                            <li><a href="#" class="nav-link block p-2 rounded-unik-md hover:bg-unik-primary/5 text-unik-primary transition-colors">Trending</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="sidebar-box bg-white rounded-unik-lg shadow-unik-sm p-6 border border-unik-border">
                        ...
                        <ul class="sidebar-list space-y-3">
                            <li>
                                <a href="#" class="nav-link flex items-start gap-3 p-2 rounded-unik-md hover:bg-unik-primary/5 transition-colors">
                            ...
                            <li>
                                <a href="#" class="nav-link flex items-start gap-3 p-2 rounded-unik-md hover:bg-unik-secondary/5 transition-colors">
                            ...
                            <li>
                                <a href="#" class="nav-link flex items-start gap-3 p-2 rounded-unik-md hover:bg-unik-accent/5 transition-colors">
